...
for item in golkulonbsegek:
    if item < 0:
        ...
        draws += 1
print(f"A szezonban a csapatnak {wins} győzelme, {losses} veresége, {draws} döntetlene volt.")
print()

print("4. feladat")
pontok = wins*3 + draws
print(f"A csapatnak a szezonban összesen {pontok} pontja lett.")
print()

print("5. feladat")
if wins > losses + draws:
    print("A csapatnak több győztes mérkőzése volt, mint a veresége és döntetlene együttvéve.")
else:
    print("A csapatnak kevesebb győztes mérkőzése volt, mint a veresége és döntetlene együttvéve.")
